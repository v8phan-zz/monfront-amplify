...
const Comment = (props) => {
  ...
  const getComments = () => {
    ...
    axios
      .get("https://srhfynoce2.execute-api.us-east-2.amazonaws.com/default/comment", { params: { blog_id } })
      .then((res) => {
  ...
  const handleClick = () => {
    ...
    axios
      .post("https://srhfynoce2.execute-api.us-east-2.amazonaws.com/default/comment", { comment, blog_id, user_id })
      .then((res) => {
        console.log(res);
      })
      .then(() => setComment(""))
