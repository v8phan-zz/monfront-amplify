...
const Comment = (props) => {
  ...
  const getComments = () => {
    ...
    axios
      .get("http://ec2-3-17-180-35.us-east-2.compute.amazonaws.com:6868/api/comment", { params: { blog_id } })
      .then((res) => {
  ...
  const handleClick = () => {
    ...
    axios
      .post("http://ec2-3-17-180-35.us-east-2.compute.amazonaws.com:6868/api/comment", { comment, blog_id, user_id })
      .then((res) => {
        console.log(res);
      })
      .then(() => setComment(""))
